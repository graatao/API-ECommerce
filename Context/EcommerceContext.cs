...
public partial class EcommerceContext : DbContext
{
    ...
    protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)       => optionsBuilder.UseSqlServer("Data Source=.\\sqlexpress;Initial Catalog=ECommerce;User Id=sa;Password=Senai@134;TrustServerCertificate=true;");
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.HasKey(e => e.IdItemPedido).HasName("PK__ItemPedi__F77088BA6898A368");
        ...
        {
            entity.HasKey(e => e.IdPagamento).HasName("PK__Pagament__D474651E69B0E47F");
        ...
        {
            entity.HasKey(e => e.IdPedido).HasName("PK__Pedido__9D335DC3CA5BE309");
        ...
        {
            entity.HasKey(e => e.IdProduto).HasName("PK__Produto__2E883C23E5ED8865");
